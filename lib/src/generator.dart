...
class ClientGenerator {
  ...
  String _generateRepository(
    ...
    if (canUpd) {
      ...
      b.writeln(
        '  Future<$className> update(String $pkParam, Map<String, dynamic> data) async {',
      );
      b.writeln(
        "    final row = await _client.from('$tableName').update(data).eq('$pk', $pkParam).select().single();",
      );
      b.writeln('    return $className.fromJson(row);');
      b.writeln('  }');
      b.writeln();
    ...
    if (canDel) {
      ...
      b.writeln('  Future<void> delete(String $pkParam) async {');
      b.writeln(
        "    await _client.from('$tableName').delete().eq('$pk', $pkParam);",
      );
      b.writeln('  }');
      b.writeln();
    }
    ...
    if (hasRealtime) {
      ...
      if (wsScoped) {
        ...
        b.writeln("        .stream(primaryKey: ['$pk'])");
